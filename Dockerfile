...
WORKDIR /tmp
RUN  https://github.com/OlafRadicke/peruschim_cpp/archive/master.zip
RUN  unzip  peruschim_cpp-master.zip
...
RUN rm -Rvf /tmp/peruschim_cpp-master /tmp/peruschim_cpp-master.zip
